...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Mail.text_body'
        db.add_column('mailarchive_mail', 'text_body',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)

        # Adding field 'Mail.html_body'
        db.add_column('mailarchive_mail', 'html_body',
                      self.gf('django.db.models.fields.TextField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Mail.text_body'
        db.delete_column('mailarchive_mail', 'text_body')

        # Deleting field 'Mail.html_body'
        db.delete_column('mailarchive_mail', 'html_body')
    ...
    models = {
        ...
        'mailarchive.mail': {
            ...
            'carboncopy': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mailarchive.Address']", 'related_name': "'carboncopy'", 'symmetrical': 'False'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'receivers': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['mailarchive.Address']", 'related_name': "'receivers'", 'symmetrical': 'False'}),
